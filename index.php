      ...
      <div class="container">
        <div class="row no-gutters slider-text js-fullheight align-items-center justify-content-start" data-scrollax-parent="true">
          <div class="col-md-6 pt-5 ftco-animate">
          	<div class="mt-5">
          		<span class="subheading" alt="Welcome to Mediplus">Welcome to Mediplus</span>
	            <h1 class="mb-4" alt="We are here for your care">We are here <br>for your Care</h1>
	            <p class="mb-4" alt="Located at the heart of Windsor. We allow easy access for all peoples in the essex county area.">Located at the heart of Windsor. We allow easy access for all peoples in the essex county area.</p>
    			...
    			<div class="col-md-6 col-lg-7 pl-lg-5 py-md-5">
    				<div class="py-md-5">
			          ...
			          <div class="col-md-12 heading-section ftco-animate p-4 p-lg-5">
			            <h2 alt="We are Mediplus, a medical clinic" class="mb-4">We Are <span>Mediplus</span> A Medical Clinic</h2>
			            <p alt="With awarded winning research in auto immune deficiency and tubular contraction. We pair the greatest minds in the world with our state of the art campus and resources. Offering for a great, and hopeful experience at a trying time.">With awarded winning research in auto immune deficiency and tubular contraction. We pair the greatest minds in the world with our state of the art campus and resources. Offering for a great, and hopeful experience at a trying time.</p>
			            <p><a href="appointment.html" class="btn btn-primary py-3 px-4" alt="Make an appointment">Make an appointment</a> <a href="#contact-section" class="btn btn-secondary py-3 px-4">Contact us</a></p>
			          </div>
			        </div>
		        </div>
	        </div>
	        	...
	        	<div class="py-lg-5">
		        	<div class="row justify-content-center pb-5">
			          <div class="col-md-12 heading-section ftco-animate">
			            <h2 class="mb-3" alt="Our Services">Our Services</h2>
			          </div>
			        </div>
			        <div class="row">
			            ...
			            <div class="media block-6 services d-flex">
			              ...
			              <div class="media-body pl-md-4">
			                <h3 class="heading mb-3" alt="Emergency Services">Emergency Services</h3>
			                <p alt="Our location allows for immediate emergency pickup anywhere in the Windsor area, with a maximum waiting time of 30 minutes.">Our location allows for immediate emergency pickup anywhere in the Windsor area, with a maximum waiting time of 30 minutes. </p>
			              </div>
			            </div>      
			          </div>
			          <div class="col-md-6 d-flex align-self-stretch ftco-animate">
			            <div class="media block-6 services d-flex">
			              ...
			              <div class="media-body pl-md-4">
			                <h3 class="heading mb-3" alt="qualified doctors">Qualified Doctors</h3>
			                <p alt="Our campus boasts some of the smartest minds in the medical profession. With research awards in Auto Immune Deficiency, and Tubular Contraction; we offer a world renowned staff.">Our campus boasts some of the smartest minds in the medical profession. With research awards in Auto Immune Deficiency, and Tubular Contraction; we offer a world renowned staff.</p>
			              </div>
			            </div>      
			          </div>
			          <div class="col-md-6 d-flex align-self-stretch ftco-animate">
			            <div class="media block-6 services d-flex">
			              ...
			              <div class="media-body pl-md-4">
			                <h3 class="heading mb-3" alt="Outdoors checkup">Outdoors Checkup</h3>
			                <p alt="You can now ask for outdoor or homecare assistance.">You can now ask for outdoor or homecare assistance.</p>
			              </div>
			            </div>      
			          </div>
			          <div class="col-md-6 d-flex align-self-stretch ftco-animate">
			            <div class="media block-6 services d-flex">
			              ...
			              <div class="media-body pl-md-4">
			                <h3 class="heading mb-3" alt="24 Hours Service">24 Hours Service</h3>
			                <p alt="The emergence ward of the hospital functions 24/7, weekdays and weekends. Allowing for immediate and reliant access to your services.">The emergence ward of the hospital functions 24/7, weekdays and weekends. Allowing for immediate and reliant access to your services.</p>
			              </div>
			            </div>      
			          </div>
			        </div>
		      ...
		      <div class="col-md-5 d-flex">
	        	<div class="appointment-wrap bg-white p-4 p-md-5 d-flex align-items-center">
		        	<form action="scheduledapp.php" class="appointment-form ftco-animate" method="post">
		        		<h3 alt="free consultation">Free Consultation</h3>
    ...
    <section class="ftco-intro img" style="background-image: url(images/bg_2.jpg);">
			...
			<div class="container">
				<div class="row justify-content-center">
					<div class="col-md-9 text-center">
						...
						<p>We can help manage your dream of building a truly healthy lifestyle</p>
                                                <p><a href="pie.php" class="btn btn-primary py-3 px-4">Department size</a></p>
					</div>
				</div>
			</div>
		</section>
    					...
    					<div class="col-md-4">
    						<div class="department-wrap p-4 ftco-animate">
    							<div class="text p-2 text-center">
    								...
    								<p>Check on your nervous system</p>
    							</div>
    						</div>
    						<div class="department-wrap p-4 ftco-animate">
    							<div class="text p-2 text-center">
    								...
    								<p>Investigate or treat injuries</p>
    							</div>
    						</div>
    						<div class="department-wrap p-4 ftco-animate">
    							<div class="text p-2 text-center">
    					...
    					<div class="col-md-4">
    						<div class="department-wrap p-4 ftco-animate">
    							<div class="text p-2 text-center">
    								...
    								<p>check on the health of your eye</p>
    							</div>
    						</div>
    						<div class="department-wrap p-4 ftco-animate">
    							<div class="text p-2 text-center">
    								...
    								<p>Check on your heart health</p>
    							</div>
    						</div>
    						<div class="department-wrap p-4 ftco-animate">
    							<div class="text p-2 text-center">
    								...
    								<p>Check on your mental health and psyche</p>
    							</div>
    						</div>
    					</div>
    					...
    					<div class="col-md-4">
    						<div class="department-wrap p-4 ftco-animate">
    							<div class="text p-2 text-center">
    								...
    								<p>World class MRI, offering great medical imaging</p>
    							</div>
    						</div>
    						<div class="department-wrap p-4 ftco-animate">
    							<div class="text p-2 text-center">
    								...
    								<p>World class medical imaging</p>
    							</div>
    						</div>
    						<div class="department-wrap p-4 ftco-animate">
    							<div class="text p-2 text-center">
		...
		<section class="ftco-section" id="doctor-section">
          ...
          <div class="col-md-8 text-center heading-section ftco-animate">
            ...
            <p>Industry leaders, at the touch of your finger</p>
          </div>
        </div>	
				<div class="row">
					<div class="col-md-6 col-lg-3 ftco-animate">
		              ...
		              <p><a href="doctors.php" class="btn btn-primary">Learn more</a></p>
	              </div>
							</div>
						</div>
					</div>
					<div class="col-md-6 col-lg-3 ftco-animate">
						<div class="staff">
							...
							<div class="text pt-3 text-center">
								...
								<div class="faded">
									<p>I see the best in people, and thats why I love what I do. Let me help you.</p>
									<ul class="ftco-social text-center">
		                <li class="ftco-animate"><a href="#"><span class="icon-twitter"></span></a></li>
		                <li class="ftco-animate"><a href="#"><span class="icon-facebook"></span></a></li>
		                <li class="ftco-animate"><a href="#"><span class="icon-google-plus"></span></a></li>
					...
					<div class="col-md-6 col-lg-3 ftco-animate">
						<div class="staff">
							...
							<div class="text pt-3 text-center">
								...
								<div class="faded">
									<p>Work oriented, but I also dont mind chatting unless theres coffee.</p>
									<ul class="ftco-social text-center">
		                <li class="ftco-animate"><a href="#"><span class="icon-twitter"></span></a></li>
		                <li class="ftco-animate"><a href="#"><span class="icon-facebook"></span></a></li>
		                <li class="ftco-animate"><a href="#"><span class="icon-google-plus"></span></a></li>
					...
					<div class="col-md-6 col-lg-3 ftco-animate">
						<div class="staff">
							...
							<div class="text pt-3 text-center">
								...
								<div class="faded">
									<p>With three kids of my own, I understand the stress of your child being ill.</p>
									<ul class="ftco-social text-center">
		                <li class="ftco-animate"><a href="#"><span class="icon-twitter"></span></a></li>
		                <li class="ftco-animate"><a href="#"><span class="icon-facebook"></span></a></li>
		                <li class="ftco-animate"><a href="#"><span class="icon-google-plus"></span></a></li>
			...
			<div class="container">
				<div class="row d-flex align-items-center">
					<div class="col-md-5 heading-section heading-section-white">
						...
						<p class="mb-0"><a href="appointment.html" class="btn btn-secondary px-4 py-3">Make an appointment</a></p>
					</div>
					<div class="col-md-7">
						<div class="row pt-4">
      ...
      <div class="container">
        <div class="row justify-content-center pb-3">
          <div class="col-md-7 text-center heading-section heading-section-white ftco-animate">
            ...
            <h2 class="mb-4">Our Patients Say</h2>
          </div>
        </div>
    ...
    <section class="ftco-section contact-section" id="contact-section">
      <div class="container">
          ...
          <div class="col-md-7 heading-section text-center ftco-animate">
            ...
            <p>We are located in the heart of Windsor, to best serve those in the Windsor/Essex County region.</p>
          </div>
        </div>
        <div class="row d-flex contact-info mb-5">
          <div class="col-md-6 col-lg-3 d-flex ftco-animate">
          	<div class="align-self-stretch box p-4 text-center bg-light">
	            ...
	            <p>198 West Wyandotte Street, Windsor On, Ca 10016</p>
	          </div>
          </div>
          <div class="col-md-6 col-lg-3 d-flex ftco-animate">
          	<div class="align-self-stretch box p-4 text-center bg-light">
	            ...
	            <p><a href="tel://1234567920">+1 226 235 5998</a></p>
	          </div>
          </div>
          <div class="col-md-6 col-lg-3 d-flex ftco-animate">
          	<div class="align-self-stretch box p-4 text-center bg-light">
	            ...
	            <p><a href="mailto:malik11y@uwindsor.ca">malik11y@uwindsor.ca</a></p>
	          </div>
          </div>
          <div class="col-md-6 col-lg-3 d-flex ftco-animate">
          	<div class="align-self-stretch box p-4 text-center bg-light">
          ...
          <div class="col-md">
            <div class="ftco-footer-widget mb-4 ml-md-4">
              ...
              <ul class="list-unstyled">
                <li><a href="#department-section"><span class="icon-long-arrow-right mr-2"></span>Neurology</a></li>
                <li><a href="#department-section"><span class="icon-long-arrow-right mr-2"></span>Opthalmology</a></li>
                <li><a href="#department-section"><span class="icon-long-arrow-right mr-2"></span>Nuclear Magnetic</a></li>
                <li><a href="#department-section"><span class="icon-long-arrow-right mr-2"></span>Surgical</a></li>
                <li><a href="#department-section"><span class="icon-long-arrow-right mr-2"></span>Cardiology</a></li>
                <li><a href="#department-section"><span class="icon-long-arrow-right mr-2"></span>Dental</a></li>
              </ul>
            </div>
          </div>
          <div class="col-md">
